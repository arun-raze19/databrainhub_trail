  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Bi-Annual Report</h1>
        <p className="text-gray-600">Here comes the Bi-Annual Report section!</p>
      </div>
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        <h4 className="text-xl font-bold mb-4">Uploaded PDF {semester}</h4>
        {allImage.length === 0 ? (
